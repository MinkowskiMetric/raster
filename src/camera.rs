...
impl Camera {
    pub fn new(position: cgmath::Vector3<f32>, width: usize, height: usize, fov: cgmath::Rad<f32>) -> Self {
    ...
    pub fn pixel_to_viewport(&self, x: usize, y: usize) -> cgmath::Vector3<f32> {
        ...
        let vx = (2_f32 * ((x + 0.5_f32) * self.inv_width) - 1_f32) * self.angle * self.aspect_ratio;
